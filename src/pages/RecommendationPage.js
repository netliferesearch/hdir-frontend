                ...
                >
                  <div className="l-mb-1">
                    <Collapsible heading="Sammendrag" size="small">
                      <p>
                        ...
                        klinisk praksis som også alle behandlingsstudier bygger
                        på og grunnlaget for den sterke anbefalingen om å gi
                        konkrete kostråd.
                      </p>
                      <p>
                        ...
                        til standard informasjon om hvilken kost som anses god.
                      </p>
                      <p>
                        Rasjonalet for å foreslå en vurdering av
                        karbohydratkvalitet og -mengde bygger på kunnskap om at
                        kost med lav glykemisk indeks er å foretrekke fremfor
                        andre kosthold for å redusere glukosenivået (Viana LV,
                        2014). Studiene inkludert i denne metaanalysen ble delt
                        inn etter type kostintervensjon (4 studier (n=257) med
                        lav-GI kost, 2 studier (n=425) med kost med total
                        energirestriksjon (ca 30% av energibehovet) og 2 studier
                        (n=182) med lavkarbohydratkost). Ved lav-GI koststudiene
                        oppnådde intervensjonsgruppene en glykemisk indeks på
                        47-49, noe som indikerer en god etterlevelse hos
                        pasienter med svangerskapsdiabetes, og evidensen fra
                        denne oppsummeringen danner grunnlaget for at kost med
                        lav glykemisk indeks foreslås fremfor andre kosttyper.
                      </p>
                      <p>
                        ...
                        fastsittende skuldre med 58% - stort barn i forhold til
                        gestasjonsalder (LGA) med 58% - makrosomi med 50%{' '}
                      </p>
                      <p>
                        Det er ikke holdepunkt for ugunstige virkninger av
                        behandlingen, som økning i keisersnitt, overføring av
                        den nyfødte til intensivavdelinger, eller økning i andel
                        barn som er små i forhold til gestasjonsalder. Heller
                        ikke er det holdepunkt for økning i angst eller
                  ...
                  <div className="l-mb-1">
                    <Collapsible heading="Vurdering" size="small">
                      ...
                      <p>
                        Av 1000 kvinner vil 44 færre få preeklampsi, det vil bli
                        20 færre barn med fastsittende skuldre under fødsel, 90
                        færre barn over 4 kg og 80 færre barn som er store for
                        gestasjonsalder ved konvensjonell behandling (oppfølging
                        og kostråd) sammenlignet med ingen behandling. Ved å
                        følge kostråd som referert i kunnskapsgrunnlaget (se
                        også praktisk info) vil flere kvinner oppnå god
                        blodsukkerkontroll uten insulin eller andre
                        medikamenter. Ulemper ved den samlede behandlingen: Det
                        er ikke holdepunkter for ulemper som økt
                        keisersnittforekomst, økt overføring til
                      ...
                      <p>
                        ...
                        Av 1000 kvinner med svangerskapsdiabetes som følger en
                        kost med lav glykemisk indeks vil 132 færre trenge
                        insulin sammenlignet med de som følger en kontrollkost.
                        Barn av mødre som fulgte en lavglykemisk kost hadde en
                        fødselsvekt som var 162 gram lavere enn barn til kvinner
                        som fulgte en kontrollkost. Det var ingen forskjell i
                        antall barn med lav fødselsvekt for gestasjonsalder
                        (SGA) mellom intervensjon- og kontrollkost. Det var
                        ingen forskjell i ufall for en energirestriktiv kost
                      ...
                      <p>
                        ...
                        preeklampsi, fastsittende skulder, makrosomi og barn som
                        er store for gestasjonsalder (LGA). Vi har lav eller
                        veldig lav tillit til effektestimatene for øvrige
                        utfall. For kostråd om karbohydratkvalitet og -mengde:
                      ...
                      <p>
                        ...
                        svangerskapsdiabetes som følger en lavkarbohydratkost
                        for utfall som
                      </p>
                      <ul>
                        <li> Andel kvinner som trenger insulin</li>
                      ...
                      <p>
                        ...
                        kan oppleves belastende for noen mødre. Noen kvinner kan
                        bli motivert av å se positiv effekt av kostholdet på
                        ...
                        glykemisk indeks er ofte dyrere. For noen kan økonomiske
                        problemer gjøre det vanskelig å følge kostrådene.
                        Regelemssig oppfølging og støtte fra helsepersonell kan
                        være avgjørende for at kvinnen mestrer den samlede
                      ...
                      <p>
                        ...
                        gravide. Helsepersonell bør ha god kompetanse om kost og
                        ulike matkulturer. Gode ferdigheter i kommunikasjon og
                        endringsfokusert veiledning en forutsetning for en god
                        dialog med den gravide og for å oppnå de ønskede
                      ...
                      <p>
                        ...
                        både den gravide og behandlere. Spesialkompetanse og god
                        tid er særllig viktig der kvinnen ikke oppnår
                      ...
                      <p>
                        ...
                        sykehusene, avhengig av ressurser, rutiner og tilgang på
                        helsepersonell med spesiell kompetanse innenfor ernæring
                        og endringsfokusert veiledning (klinisk
                        ernæringsfysiolog, jordmor, diabetessykepleier, andre).
                        Internasjonale retningslinjer (NICE 2015, CDA 2013, ADA
                        2012) anbefaler at kvinner med svangerskapsdiabetes
                        henvises til klinisk ernæringsfysiolog for
                        kostråd/kostveiledning. I dag er det liten eller ingen
                        tilgang på denne ressursen/kompetansen i
                  ...
                  <div className="l-mb-1">
                    <Collapsible heading="Referanser" size="small">
                      <p>
                        ...
                        Effects of interventions in pregnancy on maternal weight
                        and obstetric outcomes: meta-analysis of randomised
                        evidence.. BMJ (British Medical Journal) 2012; Pubmed
                        Journal
                      </p>{' '}
                      <p>
                        <b>Hartling L, Dryden DM, Guthrie A et al</b> : Benefits
                        and harms of treating gestational diabetes mellitus: a
                        ...
                        Research.. Annals of Internal Medicine 2013; Pubmed
                        Journal
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        Diabetes Research and Clinical Practice 2012; Pubmed
                        Journal
                      </p>{' '}
                      <p>
                        <b>Prutsky GJ, Domecq JP, Wang Z et al </b>: Glucose
                        targets in pregnant women with diabetes: a systematic
                        review and meta-analysis.. JCEM (The Journal of Clinical
                        Endocrinology & Metabolism) 2013; Pubmed Journal
                      </p>{' '}
                      <p>
                        <b>Porter H, Lookinland S, Belfort MA</b> : Evaluation
                        of a new real-time blood continuous glucose monitoring
                        system in pregnant women without gestational diabetes. A
                        pilot study.. The Journal of Perinatal & Neonatal
                        Nursing 2004; Pubmed
                      </p>{' '}
                      <p>
