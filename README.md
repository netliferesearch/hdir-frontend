...
3. Run `npm run build`
4. Generate static pages `npm run create-static-pages`
5. Run `diff-static-versions`
6. Open `/public/diff.html` to see the changes. Edit: The new diffs includes the date in the filename. 
