      ...
      <div className="row l-mt-3">
        ...
        <div className="col-md-7 col-md-offset-1">
          ...
          <article className="t-body-text l-mt-2">
            ...
            <ol>
              <li>
                Nettkurs og kurs i akuttmedisin for leger (ikke turnusleger) og
                annet helsepersonell i legevakt som ikke har gjennomgått slikt
                kurs.
              </li>
              <li>
            ...
            <ol>
              <li>
                ...
                dagtid: kr 5000 i kursavgift per deltaker og kr 250 per deltaker
                for nettkurs dekkes. For fast ansatte fastleger og annet
                helsepersonell dekkes også kr 4000 i reise/oppholdsutgifter per
                deltaker.
              </li>
              <li>
                Nettkurs i volds- og overgrepshåndtering for leger og annet
                ...
                dekkes. For selvstendig næringsdrivende fastleger og vikarleger
                gis også kr4000 i lønnskompensasjon per deltaker.
              </li>
              <li>
              ...
              <li>
                ...
                henhold til kravet i forskriften §13 f, om "relevant helsefaglig
                utdanning på bachelornivå" (f.eks. sykepleiere/vernepleiere).
                Differansen dekkes med inntil kr5000 per måned per
            ...
            <ul>
              <li>
                informasjon om søker, adresse, organisasjonsnummer, kontonummer,
                kontaktperson
              </li>
              ...
              <li>
                redegjørelse for de interne og eksterne kontrolltiltak som skal
                sikre korrekt rapportering og måloppnåelse (for eksempel interne
                kontrollaktiviteter, internrevisjon, autorisert revisor / ikke
                autorisert revisor, andre offentlige tilsyn og Riksrevisjonen).
              </li>
            </ul>
            <p>
