...
storiesOf('Velkommen', module)
  .addWithStaticMarkup('Kom i gang', () => (
    <Wrapper title="Kom i gang" lead="Helsedirektoratet og HELFO på nett.">
      <div>
        <p>Formålet med denne "Storybooken" er å dokumentere alle delene av nettsidene, i form av komponenter. </p>
