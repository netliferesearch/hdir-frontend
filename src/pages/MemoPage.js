    ...
    <div className="l-container">
      ...
      <div className="row l-mt-4">
        ...
        <article className="col-md-8 col-xs-12 col-md-offset-1 t-body-text">
          ...
          <p>
            Bestemmelsen pålegger helsepersonell i privat virksomhet å melde om
            åpning, overtakelse, inntreden eller opphør i virksomhet som yter
            helsetjenester.
          </p>
          <p>
          ...
          <p>
            ...
            spesialisthelsetjeneste skal gi melding til regionalt helseforetak,
            mens helsepersonell i annen virksomhet skal gi melding til kommunen.
            Dette gjelder også for eksempel spesialister i sykehus som påtar seg
            oppgaver i privat virksomhet utenfor spesialisthelsetjenesten.
          </p>
          <h4>Andre ledd</h4>
          <p>
            Andre ledd første punktum er en pliktbestemmelse for helsepersonell.
            Det følger av bestemmelsen at helsepersonell som åpner, overtar
            eller trer inn i virksomhet som skal yte helsehjelp til barn eller
            personer med utviklingshemming, skal fremlegge politiattest for
            kommune eller regionalt helseforetak. Plikten til å fremlegge
            politiattest følger av helsepersonelloven § 20 a Andre punktum er en
            pliktbestemmelse for kommune og regionale helseforetak. Bestemmelsen
            pålegger kommunen eller helseforetaket straks å sende en
            politiattest med anmerkninger videre til Fylkesmannen.
          </p>
          <h4>Tredje ledd</h4>
          <p>
          ...
          <Quote>
            <p>
              «Helsepersonell med autorisasjon eller lisens skal av eget tiltak
              gi arbeidsgiveren opplysninger om bierverv og engasjement,
              eierinteresser o.l. i annen virksomhet som vil kunne komme i
            ...
            <p>
              Det skal gis opplysning om virksomhetens navn og arten og omfanget
              av helsepersonells bierverv eller engasjement.
            </p>
            <p>
          ...
          <p>
            ...
            tilliten til den offentlige helsetjenesten at det ikke oppstår tvil
            om at avgjørelser tas av hensyn til pasienten og en fornuftig
